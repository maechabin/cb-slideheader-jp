...
})(SLIDE_TYPE = exports.SLIDE_TYPE || (exports.SLIDE_TYPE = {}));
var METHOD_TYPE;
(function (METHOD_TYPE) {
    METHOD_TYPE["SLIDE_DOWN"] = "slideDown";
    METHOD_TYPE["SLIDE_UP"] = "slideUp";
})(METHOD_TYPE = exports.METHOD_TYPE || (exports.METHOD_TYPE = {}));
var SLIDE_TIMING;
...
})(SLIDE_TIMING = exports.SLIDE_TIMING || (exports.SLIDE_TIMING = {}));
...
var SlideHeader = /** @class */function () {
    function SlideHeader(element, options) {
        this.methodType = app_model_1.METHOD_TYPE.SLIDE_DOWN;
        this.slideDirection = app_model_1.SLIDE_TYPE.UP;
        ...
        this.defaults = {
            ...
            slideDownTiming: app_model_1.SLIDE_TIMING.EASE,
            slideUpTiming: app_model_1.SLIDE_TIMING.EASE,
    ...
    SlideHeader.prototype.handleScroll = function (top, slideType) {
        ...
        this.slideDirection = this.slideDirection === app_model_1.SLIDE_TYPE.UP ? app_model_1.SLIDE_TYPE.DOWN : app_model_1.SLIDE_TYPE.UP;
    };
    ...
    SlideHeader.prototype.runSlideHeader = function () {
        var _this = this;
        var top1 = this.methodType === app_model_1.METHOD_TYPE.SLIDE_DOWN ? 0 : "-" + this.config.headerBarHeight + "px";
        var top2 = this.methodType === app_model_1.METHOD_TYPE.SLIDE_DOWN ? "-" + this.config.headerBarHeight + "px" : 0;
        var slideType1 = this.methodType === app_model_1.METHOD_TYPE.SLIDE_DOWN ? app_model_1.SLIDE_TYPE.DOWN : app_model_1.SLIDE_TYPE.UP;
        var slideType2 = this.methodType === app_model_1.METHOD_TYPE.SLIDE_DOWN ? app_model_1.SLIDE_TYPE.UP : app_model_1.SLIDE_TYPE.DOWN;
        var startingScrollTop = 0; // スライドの開始位置
        var currentScrollTop = 0; // 現在のスクロールの位置
        var style1 = "\n      box-shadow: " + this.config.boxShadow + ";\n      transition: 'box-shadow .9s linear',\n    ";
        var style2 = "\n      box-shadow: none;\n    ";
        var css1 = this.methodType === app_model_1.METHOD_TYPE.SLIDE_DOWN ? style1 : style2;
        var css2 = this.methodType === app_model_1.METHOD_TYPE.SLIDE_DOWN ? style2 : style1;
        window.addEventListener('scroll', function () {
            currentScrollTop = document.documentElement.scrollTop || document.body.scrollTop;
            if (_this.methodType === app_model_1.METHOD_TYPE.SLIDE_UP && _this.config.isHeadroom) {
                /** Headroom時 */
                if (currentScrollTop > startingScrollTop && currentScrollTop > _this.config.slidePoint) {
                    if (_this.slideDirection === app_model_1.SLIDE_TYPE.UP) {
                        _this.handleScroll(top1, slideType1);
                    }
                } else {
                    if (_this.slideDirection === app_model_1.SLIDE_TYPE.DOWN) {
    ...
    SlideHeader.prototype.applyStyle = function () {
        var top = this.methodType === app_model_1.METHOD_TYPE.SLIDE_DOWN ? "-" + this.config.headerBarHeight + "px" : 0;
    ...
    SlideHeader.prototype.init = function (type) {
        if (type && type in app_model_1.METHOD_TYPE) {
